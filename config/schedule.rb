...
every 4.hour, at: "4:30 am", :roles => :app do
  rake "set:flash_sale"
...
every 4.hour, at: '6:00 am', :roles => :app do
  ...
  AToZ,BrickAndMortar,Olshan,RoyalLivingNYC,ToveRealty,WindsorMariners,KeyWorthyLLC,NYVirtualRealtyCorp,Chapin,FurnishedDwellings,NelsonAybar,VertexRealty,CitadelProperty,Lalezarian,Dermot,ShawnBenn,SharpManagement,TheCorner,DouglasElliman,Ilistllc,KartenLowe,Fiddler,OneAndOnly,Swythe,Galleria,NewYorkHomes,SkyRealEstate,GPSRealty,JackResnick,Parkstone,Nectar,PrimeHome,ArdmoreWinthrop,Gama,AAManagement,Westminster,Rosenyc.LuxuryChicago,Akelius,Estilo,Bedford,FiveStar,BHTal,Panthera,KellerWilliams,Chartwell,Fetner,Realty2000,Realtyka,Elanrealty,Buzzer,PerlGroup,HarrisonCourt,MasonGroup,HmrProperties,AllAmericanRltyMgt,DansarGroup,ClipperEquities,HomedaxRealestate,Properties99,KellerWilliamsMidtown,MetropolitanRealty,NorthStar,JpAssociates,Horowitz,CurzonRealEstate,DwellChicago,CrumlishRealEstate,DevCoGroup,CarnegieHillProperties,TheMonterey,BohemiaRealty,RenegadeNY,AventanaRealEstate,ArmCapital,InHausLlc,ShorecrestTowers,PerryAssociates,OakTree,Waterton,Resis,GlaProperty,AptAmigo,JcaProperty,VoyeurRealEstate,NovoProperties,IndependentProp,AkeliusRealestate,WingateCompanies,TheRealEstate,SimplyBrooklyn,FifthForever,DrennenRealty,SilverkeyRealty,MQPropertyMgmt,LifestyleRealty,GioiaRealty,SpyRLT,IqRealtors,SolarManagement,BlantonTurner,DJKResidential,GothamOrganization,BrennanRealty,CicadaInternational,SingerNY,ExcelsiorRealty,FennelRealty,BuchbinderWarren,BsdRealty,LoftsAndFlats,Tryax,Caprijetrealty,Madoinc,U2apartment,Hotspot,Promisereal,Glasserreal,Fetnerpropinc,Fountainreal,Manchesterreal,Pistillireal,Atkinson,Brookblocreal,Peterkinang,Thesuitliber\""
end
