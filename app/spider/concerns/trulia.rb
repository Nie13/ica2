  ...
  module Xml
    module Trulia
      NESTIOLIST = ["AToZ", "Anchornyc", "BoldNewYork",
                   ...
                   "Instratany", "Lucienperry", "IanShapolsky","UptownFlats","ModaRealty","ToveRealty","WindsorMariners",
