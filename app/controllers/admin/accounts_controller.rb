class Admin::AccountsController < Admin::BaseController
  ...
  def account_params
    params.require(:account).permit(:first_name, :last_name, :first_phone, :last_phone,:email, :password, :password_confirmation, :role, mail_notify_attributes: [:is_recommended])
  end
end
